...
import { isNotNilOrEmpty } from './ramda-extra.js';
...
var formatTime = function formatTime(time) {
  ...
  return isNotNilOrEmpty(time) ? moment(time).locale('zh-cn').format(format) : '';
};

export { FORMAT_DATETIME_MEDIUM, formatTime, setupLocale };
